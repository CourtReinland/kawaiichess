...
public class MagicalGirlRook : Piece
{
    ...
    public void CastBarrier(Vector2Int allyPosition)
    {
        Debug.Log($"{PieceName} casts Barrier on ally at {allyPosition}");
        // TODO: Add actual barrier logic later
    }
}